  ...
  <v-container id="exercise-four">
      <v-row outlined color="blue">
       <v-col cols="3">
        ...
        <v-img class="white--text align-end" height="200px" src="../assets/img1.jpg">
        ...
        <v-btn color="orange" text >
           ...
           <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img2.jpg">
        ...
        <v-btn color="orange" text >
         ...
         <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img3.jpg">
        ...
        <v-btn color="orange" text >
            Explore
               ...
               <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img4.jpg">
        ...
        <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img5.jpg">
        ...
        <v-btn color="orange" text >
           ...
           <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img6.jpg">
        ...
        <v-btn color="orange" text >
         ...
         <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img7.jpg">
        ...
        <v-btn color="orange" text >
            Explore
               ...
               <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img8.jpg">
        <v-card-title>Hovhannes Tumanyan</v-card-title>
        </v-img>
        <v-card-subtitle class="pb-0">Number 8</v-card-subtitle>
        <v-card-text class="text--primary block-with-text">
        <p> Hovhannes Tumanyan (February 19 [O.S. February 7] 1869 – March 23, 1923) was an Armenian poet, writer, translator, literary and public activist. He is considered the national poet of Armenia.
...
Tumanyan's work is simple, natural and poetically inspired at the same time. It is not by mere chance that dozens of phrases and expressions from Tumanyan's works have become a natural part of people's everyday language, their sayings, adages, and maxims.He created lyrics, fables, epic poems and translations into Armenian of Byron, Goethe and Pushkin.</p>
        </v-card-text>
        <v-card-actions>
        <v-btn color="orange" text>
            Share
        ...
        <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img9.jpg">
...
The main actors of drama “Gikor” are Albert Gulinyan as Gikor, Sos Sargsyan as Hambo, Galya Novents as Nani and Armen Dzhigarkhanyan as Bazaz Artem. These talented actors act in such a natural and real way, and the heartbreaking scenes are so touching that will surely make you cry.
        ...
        <v-btn color="orange" text >
           ...
           <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img10.jpg">
...
The film is unique and meaningful. It worth watching. One of the greatest actor Mher Mkrtchyan is the leading actor. And his wife Galya Novents as a Siranush. The artistic talents of these people are so big that we will always remember their prominent names. Albert Mkrtchyan directed the film in 1985.
        ...
        <v-btn color="orange" text >
         ...
         <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img11.jpg">
        <v-card-title>The men</v-card-title>
        </v-img>
        <v-card-subtitle class="pb-0">Number 12</v-card-subtitle>
        <v-card-text class="text--primary block-with-text">
...
The role of Aram was playing Avetik Gevorgyan, and the beautiful lady Karine was talented Alla Tumanian. “The men’’ was loved by the audience and as an honor, a statue of the heroes placed in the central Saryan park of our capital, Yerevan.
        ...
        <v-btn color="orange" text >
            Explore
               ...
               <v-col cols="3">
        <v-card class="mx-auto" max-width="400">
        <v-img class="white--text align-end" height="200px" src="../assets/img12.jpg">
